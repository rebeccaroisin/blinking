...
\begin{flushleft}
{\Large
\textbf\newline{Accurate Molecular Sizing of Single Molecules Limited by Rhodamine Photoblinking}
}
\newline
% Insert Author names, affiliations and corresponding author email.
\\
Kristian A. Ganzinger\textsuperscript{1, \Yinyang},
Rebecca R. Murphy\textsuperscript{1, \Yinyang},
Vladimiras Olenikovas\textsuperscript{2, \Yinyang},
Sophie E. Jackson\textsuperscript{1},
David Klenerman\textsuperscript{1},
\\
\bf{1} Department of Chemistry, University of Cambridge, Cambridge, UK
\\
\bf{2} Department of XXX, University College London, London, UK
\\
...
\end{tabular}
\begin{flushleft} 
Each sequence is shown in the 3' - 5' direction/ {\bf 5} is a maleimide linkage to Alexa Fluor 488, present in the fluorescently labelled DNA strands, but absent in their unlabelled partners.
\end{flushleft}
...
\subsection*{Confocal Measurements of Holliday Junctions}

\subsection*{Photobleaching Analysis of Holliday Junctions}
...
\subsection*{Confocal Measurement of the Holliday Junctions}
\subsection*{Understanding the Photon Emission Distribution Through Mathematical Modelling}
\subsection*{Photobleaching Analysis of the Holliday Junctions Identifies Sources of Heterogeneity}
